...
const widgets = [
  ...
  { type: 'table', title: '表格', detail: { label: '表格', bordered: true }, icon:require('../assets/widgets/table.gif') },
  { type: 'tablecol', title: '表格列', detail: { label: '表格列',align:'left' }, icon:require('../assets/widgets/tablecol.gif') },
